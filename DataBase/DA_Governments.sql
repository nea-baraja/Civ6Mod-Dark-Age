...
insert or replace into Types(Type,  Kind) values
    ...
    ('GOVERNMENT_PHARAONIC_RULE',           'KIND_GOVERNMENT'),    
...
('GOVERNMENT_PHARAONIC_RULE',      'LOC_GOVERNMENT_PHARAONIC_RULE_NAME',
'LOC_DA_GOVERNMENT_PHARAONIC_RULE_INHERENT_BONUS',     'GOVERNMENTBONUS_OVERALL_PRODUCTION',   'LOC_DA_GOVERNMENT_PHARAONIC_RULE_BONUS','LOC_DA_GOVERNMENT_PHARAONIC_RULE_BONUS',
...
insert or replace into Government_SlotCounts(GovernmentType, GovernmentSlotType, NumSlots) values
    ...
    ('GOVERNMENT_PHARAONIC_RULE',           'SLOT_ECONOMIC',    2),    
